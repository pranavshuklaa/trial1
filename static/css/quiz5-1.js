...
submit.addEventListener('click',()=>{
   ...
   if(checkedAnswer==0){
    ...
    // }
        ...
        <h3>End of Test</h3>
        `
        console.log("You scored ${score}/30")
        showScore.innerHTML=`<h6>
         Description:
         Congratulations on completing the quiz! This quiz was designed to help you understand the severity of your mental illness. By clicking the "Solution" button, you will be taken to a solution page where you will find various solutions for different levels of mental illness. Good luck on your journey towards better mental health.
        ...
        console.log(val)
        if(val>=0 && val<=4){
            submit.innerHTML=`<h4>Minimal</h4>`
        }
        else if(val>5 && val<=9){
            submit.innerHTML=`<h4>Low</h4>`
        }
        else if(val>10 && val<=14){
            submit.innerHTML=`<h4>Medium</h4>`
        }
        else{
            submit.innerHTML=`<h4>High</h4>`
        }
        // else{
